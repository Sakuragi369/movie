...
class BaseCaptchaTextInput(MultiWidget):
    ...
    def __init__(self, attrs=None):
        widgets = (
            HiddenInput(attrs),
            TextInput(attrs={'class':'denglu_shuru2 f-left dl_yanzheng','placeholder':ugettext_lazy(u'Authorization')}),
        )
...
class CaptchaTextInput(BaseCaptchaTextInput):
    ...
    def render(self, name, value, attrs=None):
        ...
        self.image_and_audio = '<img src="%s" alt="captcha" class="denglu_yanzheng zhizhen f-right captcha" />' % self.image_url()
